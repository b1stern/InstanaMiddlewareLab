...
<AnchorLinks>
  ...
  <AnchorLink>Java Profiling</AnchorLink>  
</AnchorLinks>
...
Scroll down to the very bottom where you a link named **"CP4I.DEMO.API.Q"**. 
...
## Summary
  ...
  In this exercise you have explored some of the key capabilities within Instana.  You epxlored kubernetes monitoring and application monitoring.
