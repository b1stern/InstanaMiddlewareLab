...
## Add Ansible Tower Automation to Your Service

- Now, we'll learn how to add addional automation to the service.  We'll be adding an Ansible Tower Automation to your Service by using the Service Composition user interface.
- Navigate back to the list of Services by clicking on "Service Library" in the upper left corner
![](images/2021-04-29-21-22-50.png)

- Click on the Composition tab at the top of the screen.
![](images/2021-04-29-20-28-46.png)
- The Composition tab allows you to compose a complex service via a drag and drop user interface.  If you explore
- Find your Service (StudentXX Vmware service)
- Expand the service by clicking on the dropdown arrow
![](images/2021-04-29-21-24-51.png)
- Then, click on the 3 vertical dots on the right of version 3.0.0.0 and select "edit"
![](images/2021-04-29-21-26-33.png)
- Next click on the "Composition" tab at the top of the screen
![](images/2021-04-29-21-28-07.png)



## Section

In this section, we will publish your new service to the Service Library
