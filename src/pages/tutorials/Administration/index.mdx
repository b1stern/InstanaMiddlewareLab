...
In the entry field, enter the name of the queue that is used for the **Quote of the Day** application.  Enter **"entity.ibmmq.queue.name:CP4I.DEMO.API.Q"**
...
Finally, click the **"Save"** button to save your Alert.
![](images/saveAlert.png)


You have now completed the section of the lab on performing Administrative Tasks within Instana.
