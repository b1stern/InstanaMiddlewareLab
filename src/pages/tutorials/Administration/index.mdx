...
In the upper left corner, you'll see that there are 5 different types of **Smart Alerts**
- Slow Calls
- Erroneous Calls
- HTTP Status Codes
- Throughput
...
# Setup an Alert for the New Event
...
In the entry field, enter the name of the queue that is used for the **Quote of the Day** application.  Enter the following value:
```sh
...
You have now completed the section of the lab on performing Administrative Tasks within Instana.  You have learned how to create a Smart Alert, a traditional Alert (Event), and learned 
