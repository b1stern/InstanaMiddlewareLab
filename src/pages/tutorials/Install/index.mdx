...
The helm install command can be found at the bottom of the output.  Hightlight the command in the the terminal. Then, right click the mouse and select **"Copy"**.
...
Press the ENTER key on your keyboard to run the helm install.
...
To exit the runmqsc shell, type **"quit"**
...
Save and exist the configuration.yaml file.   In "vi", you type ":wq" to save and exit the file.
