...
Double check and make sure that the "sed" command properly replaced the web application key with the key from the web application that you defined.
...
<ArticleCard
    color="dark"
    title="Explorer Instana"
    subTitle="Explore the Instana UI and Capabilities"
...
<ArticleCard
    ...
    subTitle="Learn How Instana Can Help you Quickly Diagnose a Complex Problem"
...
<ArticleCard
    ...
    subTitle="Learn How to Perform Administrative Tasks in Instana"
