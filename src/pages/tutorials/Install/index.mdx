...
- Stop the ACE server
- Run the following command to "Install" the **User Exit**:  mqsichangeflowuserexits <integrationNodeName> -o -x /var/mqsi/shared-classes
- Start the ACE server
- Activate the **User Exit** by typing:  mqsichangeflowuserexits <integrationNodeName> -o -a ACEOpenTracingUserExit
